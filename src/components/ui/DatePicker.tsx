                    ...
                    {days.map((day, index) => {
                      ...
                      return (
                        <button
                          ...
                          className={`aspect-square rounded-lg text-sm font-medium transition-all touch-manipulation min-h-[44px] flex items-center justify-center ${
                            selected
                ...
                {days.map((day, index) => {
                  ...
                  return (
                    <button
                      ...
                      type="button"
                      onClick={() => handleDateSelect(day)}
                      className={`aspect-square rounded-lg text-sm font-medium transition-all touch-manipulation min-h-0 flex items-center justify-center ${
                        selected
                          ? 'bg-gray-900 dark:bg-white text-white dark:text-gray-900 font-semibold'
                          : today
                          ? 'bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-white font-semibold ring-1 ring-gray-300 dark:ring-gray-600'
